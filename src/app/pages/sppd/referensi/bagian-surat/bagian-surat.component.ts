...
@Component({
    ...
    templateUrl: './bagian-surat.component.html',
    styleUrl: './bagian-surat.component.scss'
})
export class BagianSuratComponent implements OnInit, OnDestroy {
    ...
    GridProps: GridModel.IGrid = {
        ...
        column: [
            { field: 'no', headerName: '#', },
            { field: 'name', headerName: 'Bagian Surat', },
    ...
    constructor(
        ...
        private _bagianSuratService: BagianSuratService,
        private _confirmationService: ConfirmationService,
        private _authenticationService: AuthenticationService,
    ) {
        this.FormProps = {
            id: 'form_bagian_surat',
            fields: [
                {
                    id: 'bagian_surat_id',
                    label: 'ID',
