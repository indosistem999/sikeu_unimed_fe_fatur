...
@Component({
    selector: 'app-jenis-transportasi',
    standalone: true,
    imports: [
        CommonModule,
        ButtonModule,
    ...
    templateUrl: './jenis-transportasi.component.html',
    styleUrl: './jenis-transportasi.component.scss'
})
export class JenisTransportasiComponent implements OnInit, OnDestroy {
    ...
    ButtonNavigation: LayoutModel.IButtonNavigation[] = [
        {
            id: 'add',
            title: 'Tambah Jenis Transportasi',
            icon: 'pi pi-plus'
        }
    ];
